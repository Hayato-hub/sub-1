    ...
    <body>
        ...
        <div class="big-body">
            <div class="body-top">
                ...
                <a href="https://a-trade.jp/redirect/eazy?media=G16531" target="_blank" class="btn-square-shadow"><i class="fab fa-apple"></i> 公式AppStoreはコチラ <i class="fas fa-external-link-alt"></i></a>
            ...
            <div class="big-body-main">
                ...
                <div class="body-main-3">
                    ...
                    <img src="{{ asset('image/eazy_app.jpg') }}">
                    <p>↑これな！</p>
                    <br>
